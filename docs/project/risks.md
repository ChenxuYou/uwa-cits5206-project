...
| R17 | A dependency vulnerability | Low | Medium | Minimal dependency surface (one NuGet package today); lockfile committed; automated vulnerability scanning on every pull request | Any scan finding a High or Critical advisory | Wenmin Luo |
