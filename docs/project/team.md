...
in meeting notes, chat and commit history. In anything the client or the facilitator reads —
presentations, reports, submissions — use the **Name** column, so that one person is never
credited twice under two names.
